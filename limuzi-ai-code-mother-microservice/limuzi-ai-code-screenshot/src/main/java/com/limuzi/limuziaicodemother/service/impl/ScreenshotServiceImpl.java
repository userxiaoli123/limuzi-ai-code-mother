...
public class ScreenshotServiceImpl implements ScreenshotService {
    ...
    private static final String baseDirName = "limuzi-ai-code-mother";
     ...
     */
    @Override
    public void deleteFileFromCos(String Key) {
    ...
    private String generateScreenshotKey(String fileName) {
        ...
        return String.format(baseDirName +"/screenshots/%s/%s", datePath, fileName);
    }
