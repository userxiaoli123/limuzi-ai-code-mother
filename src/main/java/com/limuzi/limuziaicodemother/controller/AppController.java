...
import com.limuzi.limuziaicodemother.model.dto.app.*;
...
public class AppController {
    ...
    @Cacheable(
            value = "good_app_page",
            key = "T(com.limuzi.limuziaicodemother.utils.CacheKeyUtils).generateKey(#appQueryRequest)",
