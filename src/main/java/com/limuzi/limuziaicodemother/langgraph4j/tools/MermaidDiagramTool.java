package com.limuzi.limuziaicodemother.langgraph4j.tools;
...
//            String cosUrl = cosManager.uploadFile(keyName, diagramFile);
            String cosUrl = cosManager.uploadFile(keyName, new FileInputStream(diagramFile), diagramFile.length(), "image/svg+xml");
            // 清理临时文件
